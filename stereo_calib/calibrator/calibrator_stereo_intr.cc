// run example:
// ./calibrator -w 9 -h 6 data/bumblebee_calib.xml
// ./calibrator -w 8 -h 6 -nr -s /home/kreso/projects/master_thesis/datasets/bumblebee/paper_calib/ ../../../../datasets/bumblebee/paper_calib_lst.xml
// ./calibrator -w 8 -h 6 -nc -nr -s /home/kreso/projects/master_thesis/datasets/bumblebee/paper_calib/ ../../../../datasets/bumblebee/paper_calib_lst.xml
//./calibrator_stereo -w 14 -h 10 -nr -s /home/kreso/projects/master_thesis/datasets/bumblebee/monitor_calib/ ../../../../../datasets/bumblebee/test_calib.xml
...
static void stereoCalib(const string src_dir, const vector<string>& imagelist, Size boardSize, bool useCalibrated=true,
...
int main(int argc, char** argv)
{
   ...
   stereoCalib(src_dir, imagelist, boardSize, true, showRectified, showCorners);
   return 0;
}
