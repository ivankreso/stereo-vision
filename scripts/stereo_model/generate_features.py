...
cam_mat = "C_bb.txt"
#base = 0.12
#out_folder_prefix = "/home/kreso/projects/master_thesis/datasets/stereo_model/points_viso00_bbcam_base_"
out_folder_prefix = "/home/kreso/projects/master_thesis/datasets/stereo_model/points_170m_bbcam_base_"
...
#baseline = np.array([0.12, 0.2, 0.3, 0.5, 0.7, 0.9, 2.0])
#baseline = np.array([0.03, 0.53716])
...
for b in range(baseline.shape[0]):
   ...
   for i in range(nframes-1):
      ...
      pixelize(imgsz, pts2d_leftc)
      pixelize(imgsz, pts2d_rightc)
      ...
      [triang_err, reproj_err, visible_num] = getErrors(pts3d[i,:,:], projs, C, Rt_prev, Rt_curr, baseline[b], imgsz, True)
