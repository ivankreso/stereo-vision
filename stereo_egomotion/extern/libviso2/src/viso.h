...
public:
  ...
  VisualOdometry(parameters param, track::StereoTrackerBase* tracker);
  // deconstructor
  ~VisualOdometry();
  ...
  std::vector<Matcher::p_match> getMatches () { return p_matched; } //TODO matcher->getMatches(); }
  std::vector<Matcher::p_match>& getFeatures() { return p_matched; }
  ...
  // TODO float getGain (std::vector<int32_t> inliers_) { return matcher->getGain(inliers_); }
