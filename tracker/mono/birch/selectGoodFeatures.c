  ...
  KLT_BOOL overwriteAllFeatures)
{
  ...
  while (1)  {
    ...
    if (ptr >= pointlist + 3*npoints)  {
      while (indx < featurelist->nFeatures)  {	
        if (overwriteAllFeatures || 
          ...
          _KLTFreeFloatImage(featurelist->feature[indx]->aff_img_last);
          _KLTFreeFloatImage(featurelist->feature[indx]->aff_img_mask);
          _KLTFreeFloatImage(featurelist->feature[indx]->aff_img_gradx);
          _KLTFreeFloatImage(featurelist->feature[indx]->aff_img_grady);
          _KLTFreeFloatImage(featurelist->feature[indx]->aff_img_mu);
          _KLTFreeFloatImage(featurelist->feature[indx]->aff_img_sigmaSqr);
          featurelist->feature[indx]->aff_img = NULL;
          featurelist->feature[indx]->aff_img_last = NULL;
          featurelist->feature[indx]->aff_img_mask = NULL;
          featurelist->feature[indx]->aff_img_gradx = NULL;
          featurelist->feature[indx]->aff_img_grady = NULL;
          featurelist->feature[indx]->aff_img_mu = NULL;
          featurelist->feature[indx]->aff_img_sigmaSqr = NULL;
          ...
          featurelist->feature[indx]->residual_aff = -1;
          featurelist->feature[indx]->residual_trans = -1;
        }
        indx++;
      }
      break;
    ...
    if (!featuremap[y*ncols+x] && val >= min_eigenvalue)  {
      featurelist->feature[indx]->x   = (KLT_locType) x; //ss
      ...
      featurelist->feature[indx]->residual_aff = -1;
      featurelist->feature[indx]->residual_trans = -1;
      featurelist->feature[indx]->lambda = 1;
      featurelist->feature[indx]->delta = 0;
      featurelist->feature[indx]->id = indx;
      indx++;
  ...
  selectionMode mode)
{
  ...
  if (tc->writeInternalImages)  {
    //ss _KLTWriteFloatImageToPGM(floatimg, "kltimg_sgfrlf.pgm");
    //ss _KLTWriteFloatImageToPGM(gradx, "kltimg_sgfrlf_gx.pgm");
    //ss _KLTWriteFloatImageToPGM(grady, "kltimg_sgfrlf_gy.pgm");
  }
